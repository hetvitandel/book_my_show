...
def bookASeat(br, bc, cost):
    ...
    tData = json.dumps(
        {'row': theaterData["row"], 'col': theaterData["col"], 'bookingArray': theaterData["bookingArray"]})
...
def showBookedUserInfo():
    ...
    if isSeatA == False:
        ...
        print("Name: {}\nGender: {}\nAge: {}\nTicket Price: {}\nPhone No: {}".format(udata["name"], udata["gender"],
                                                                                     udata["age"], udata["tprice"],
                                                                                     udata["phone"]))
    else:
        print("\nNot Booked yet!!\n")
    return
...
def main():
    j = print("Welcome to Rajhans Multiplex")
